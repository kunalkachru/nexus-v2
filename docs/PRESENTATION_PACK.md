...
Use it as the compact presenter-facing map of the strongest materials in the repo.

## Start Here

1. Product pitch and first impression
   - [README.md](../README.md)

2. Submission runbook
...
5. Screen-by-screen speaker notes
...
The strongest way to present NEXUS v2 is:
