...
- guided demo bundles on `/inputs` for the strongest stakeholder walkthroughs
...
6. [Buyer proof package](/Users/kunalkachru/Documents/nexus-v3/docs/public/BUYER_PROOF_PACKAGE.md)
