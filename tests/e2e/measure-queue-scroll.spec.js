...
test('Measure Queue screen scroll depth', async ({ browser }) => {
  const context = await browser.newContext();
  const page = await context.newPage();

  console.log('\n[MEASURING] Opening Queue (Command Center) screen...');
  ...
  console.log(`\n[RESULT] Current Queue screen scroll depth: ${metrics.scrollRatio}x`);
